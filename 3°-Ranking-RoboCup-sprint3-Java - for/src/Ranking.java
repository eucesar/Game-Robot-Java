...
public class Ranking {
        ...
        do {
            ...
            for (int i = 0; i < equipes.length; i++) {
                ...
                do {
                    ...
                    if (numCadaEquipe >= 11 && numCadaEquipe <= 99 && !contemNumero(equipes, numCadaEquipe)) {
                        equipes[i] = numCadaEquipe;
                        numeroValido = true;
                    } else {
                        System.out.println("Número inválido ou já em uso. Informe um número válido e único.");
                    }
                } while (!numeroValido);
    ...
    // Função para verificar se um número já está no array de equipes - 1° Parte
